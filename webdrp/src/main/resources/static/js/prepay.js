...
$("#selectPackage").click(function () {
	...
	console.log("buyCount="+realBuyCount);
	$.post(ctxPath+"wechat/api/createOrderAndPay", {"packageId":pkgId,"count":realBuyCount,"takeName":takeName,"takeTel":takeTel,"address":address},
		function(data){
			if (data.status){
